...
class ImergePlugin {
    ...
    apply(compiler) {
        compiler.hooks.afterPlugins.tap("ImergePlugin", (compiler) => {
            this.images = {};
        });

        compiler.hooks.thisCompilation.tap("ImergePlugin", (compilation) => {
            compilation.hooks.additionalAssets.tapAsync("ImergePlugin", (callback) => {
            ...
            compilation.hooks.optimizeChunkAssets.tapAsync("ImergePlugin", (chunks, callback) => {
        ...
        compiler.hooks.compilation.tap("ImergePlugin", (compilation) => {
            compilation.hooks.normalModuleLoader.tap("ImergePlugin", (loaderContext) => {
